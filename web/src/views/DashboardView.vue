...
// --- HELPERS ---
const rangeLabel = computed(() => newOrder.range >= 100 ? 'Nielimitowany' : `${newOrder.range} KM`)
    ...
    <div class="sidebar">
      <div class="user-profile-section">
          ...
          <div v-else style="display: flex; flex-direction: column; gap: 5px;">
              ...
              <label style="font-size: 10px; color: #999;">Avatar URL</label>
         ...
         <div v-if="currentCandidates.length > 0" 
            ...
            <div class="card-overlay">
                ...
                <div style="display: flex; gap: 10px;">
                    <span class="info-pill">📍 {{ newOrder.range }} km</span>
                    <span class="info-pill price-pill">{{ getBudgetSign(currentCandidates[0].priceLevel) }}</span>
                    <div class="info-pill stars-pill">
                      <span v-for="n in 5" :key="n" class="star-icon" :style="getStarStyle(n, currentCandidates[0].rating)">★</span>
                      <span style="margin-left: 5px; font-size: 12px; font-weight: bold;">{{ currentCandidates[0].rating }}</span>
                  </div>
                </div>
            </div>
         </div>
